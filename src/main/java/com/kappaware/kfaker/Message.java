...
public class Message {
	...
	public void setOverallCounter(long overallCounter) {
		this.overallCounter = overallCounter;
	}
	public long getRecipientCounter() {
		return recipientCounter;
	}
	public void setRecipientCounter(long recipientCounter) {
